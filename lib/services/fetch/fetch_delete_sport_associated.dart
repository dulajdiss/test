...
Future<List<SportAssociate>> fetchDeleteSportsAssociated(String sportId) async {
  Map<String, String> map = {};
  List<SportAssociate> responseOfAchievementModel = [];
  // map["user_id"] = await read(SharedPreferencesConstant.userId);
  map["sa_id"] = sportId;
  var url = Uri.http(APIConstants.MAIN_BASE_URL, APIConstants.DELETE_SPORT_ASSOCIATE, map);
  print('YooooKK Delete Sport Associated KKooooY => $url');
