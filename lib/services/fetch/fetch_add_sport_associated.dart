...
Future<List<SportAssociate>> fetchAddSportsAssociated(String sport) async {
  Map<String, String> map = {};
  List<SportAssociate> responseOfAchievementModel = [];
  map["user_id"] = await read(SharedPreferencesConstant.userId);
  map["sport"] = sport;
  var url = Uri.http(APIConstants.MAIN_BASE_URL, APIConstants.ADD_SPORT_ASSOCIATE, map);
  print('YooooKK Add Sport Associated KKooooY => $url');
